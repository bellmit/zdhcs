...
@ComponentScan(basePackages = {
		"net.northking.atp.controller,net.northking.atp.impl,"
		+ "net.northking.atp.db.service,net.northking.atp.db.impl,"
		+ "net.northking.atp.producer,net.northking.atp.mq" })
