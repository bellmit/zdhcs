...
import net.northking.atp.service.CaseDemandService;
 ...
 */
@Service
public class CaseDemandServiceImpl implements CaseDemandService {
   // private int num;
    ...
    public List<Map<String, Object>> generateListForQuery(
        ...
        for (ReCaseDemandTree caseDemandTree : allList){
            allMap.put(caseDemandTree.getMenuId(),caseDemandTree.toMap());
        }
        List<Map<String,Object>> oneList = new ArrayList<Map<String, Object>>();
        int num = 0;
        int all = Integer.parseInt(toolList.get(0).get("count")+"");
        for(int i=0;i<all;i++){
            ReCaseDemandTree cdm = list.get(num);
    ...
    private List<Map<String,Object>> recursiveList(List<Map<String,Object>> oneList,int ceng,int num,
       List<ReCaseDemandTree> list,List<Map<String,Object>> toolList,Map<String,Map<String,Object>> allMap){
        ...
        for(int k = 0;k<dataLevel-cengLevel;k++){
            ...
            for(Map<String,Object> map : oneList){
                String menuIdFa = getDemandMenuId(map.get("menuId")+"",1);
            ...
            for(Map<String,Object> map : toolCengList){
                ...
                if(!midMap.containsKey(map.get("menuId"))){
                    ...
                    midMap.put((String)map.get("menuId"),"1");
                    stopList.add(map);
                }
            }
            oneList = new ArrayList<Map<String, Object>>();
    ...
    //返回目标节点id
    private String getDemandMenuId(String menuId,int num){
