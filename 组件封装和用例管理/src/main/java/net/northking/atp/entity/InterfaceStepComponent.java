...
public class InterfaceStepComponent {
    ...
    public static final String KEY_paramScriptList = "paramScriptList";
    ...
    @ApiModelProperty("参数list")
    private List<InterfaceComponentParameter> paramScriptList;
    ...
    public List<InterfaceComponentParameter> getParamScriptList() {
        return paramScriptList;
    }

    public void setParamScriptList(List<InterfaceComponentParameter> paramScriptList) {
        this.paramScriptList = paramScriptList;
    }
